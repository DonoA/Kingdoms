 ...
 */
public class General extends Trait {
    ...
    public General(Municipality municipal) {
        super("General");
    ...
    public class getArmor implements FiniteStateMachine.FsmState {
        ...
        @Override
        public void invoke() {
            if (!npc.getNavigator().isNavigating() && !assignedNav) {
    ...
    public class patrol implements FiniteStateMachine.FsmState {
